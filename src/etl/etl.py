...
class ETL():
    ...
    def _join_tables(self) -> None:
        ...
        customer_order = self._customers.merge(self._orders, how='left', on='customer_id')
        customer_order_payment = customer_order.merge(self._order_payments, how='left', on='order_id')
